...
// Score submission - NEED BACKEND STUFF

let playerName = document.querySelector(".playerName");
let scoreForm = document.querySelector(".scoreForm");
let scoreMadeInput = document.querySelector(".scoreMade");
...
function submitForm(event) {
  if (playerName.value === "") {
    ...
    scoreMadeInput.value = bestScore;
    alert(
      playerName.value + " : Your score of " + bestScore + " has been sent !"
    );
  }
}
